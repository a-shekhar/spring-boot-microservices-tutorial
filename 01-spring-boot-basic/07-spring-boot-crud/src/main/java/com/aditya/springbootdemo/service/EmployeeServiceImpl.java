...
public class EmployeeServiceImpl implements EmployeeService{
    ...
    public Employee getEmployeeById(String id) {
        return employees.stream().filter(employee -> employee.getEmployeeId().equals(id)).findFirst().orElseThrow(
    ...
    public String deleteEmployeeById(String id) {
        Employee employee = employees.stream().filter(emp -> emp.getEmployeeId().equalsIgnoreCase(id))
                .findFirst().get();
